...
DIR=chroot
PREINSTALL_PKGS=openssh-server,curl,tar,gcc,libc6-dev,time,strace,sudo,less,psmisc,git,wget,vim
...
ARCH=$(uname -m)
RELEASE=xenial
# by wkn --dir in /usr/share/debootstrap/scripts
FEATURE=minimal
SEEK=2047
PERF=false
...
sudo cp -r /home/ubuntu/readtwice $DIR/
